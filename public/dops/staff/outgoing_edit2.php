		...
		<div class="panel panel-default" style="background-color:#393f4d;" id="panel-margin">
			...
			<div class="panel-body">
				...
				<form method="POST" enctype="multipart/form-data" action="save_file_editOutgoing2.php">
					...
					<button class="btn btn-primary btn-sm" name="update_outgoing"><span class="glyphicon glyphicon-plus"></span> Add File</button>
				</form>
				<br style="clear:both;"/>
					...
					<tbody>
						...
						<tr class="del_file<?php echo $fetch['store_id']?>">
							...
							<td><?php echo $fetch['date_uploaded']?></td>
                                                        <td><a href="download.php?store_id=<?php echo $fetch['store_id']?>" class="btn btn-primary"><span class="glyphicon glyphicon-download"></span> Download</a> |<a href="outgoing_edit.php?store_id=<?php echo $fetch['store_id']?>" class="btn btn-danger btn_edit" type="button"><span class="glyphicon glyphicon-edit"></span> Edit</a></td>
						</tr>
						<?php
							}
						?>
