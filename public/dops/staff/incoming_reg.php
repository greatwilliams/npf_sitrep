                ...
                <div class="container-fluid">
                    ...
                    <div class="col-12 grid-margin stretch-card">
                        ...
                        <div class="card-body">
                            ...
                            <form class="forms-sample" enctype="multipart/form-data" method="POST" action="../save_incoming.php" >
                            <div class="form-group">
                                <label for="exampleInputName1">Sender/Author</label>
                                <input type="text" class="form-control" id="exampleInputName1" placeholder="Sender/Author Address" name="address" required="required">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputCity1">Subject Matter</label>
                                <input type="text" class="form-control" id="exampleInputCity1" placeholder="Subject Matter" name="subjectMatter" >
                            </div>
                            <div class="form-group">
                                <label for="exampleInputCity1">Refernce Number</label>
                                <input type="text" class="form-control" id="exampleInputCity1" name="policy" placeholder="Enter Refernce Number" >
                            </div>
                            <div class="form-group">
							...
							<!-- <div>
								...
								<input class="form-control" id="exampleInputEmail3" placeholder="Incoming Date"
                                type="date" name="lastactioned" class="form-control" data-zdp_readonly_element="false"  required="required">
                            </div> -->
