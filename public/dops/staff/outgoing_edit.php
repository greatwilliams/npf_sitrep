            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                        <div class="card-body">
                            <form class="forms-sample" enctype="multipart/form-data" method="POST" action="../save_file_editOutgoing.php" >
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="exampleTextarea1" rows="4" placeholder="Enter Remarks" name="remarks" required="required"><?php  echo $remarks; ?></textarea>
                            </div>
                            ...
                            <button type="submit"  name="update_outgoing" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Submit</button>
