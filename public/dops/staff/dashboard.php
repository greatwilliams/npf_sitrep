                                        ...
                                        <div class="col mr-2">
											...
											<?php 
												$query = mysqli_query($conn, "SELECT COUNT(folio_no) as folio_count 
																			FROM `file_volume` WHERE `user_id` = '$_SESSION[user]' ") or die(mysqli_error());
...
<?php 
    $query = mysqli_query($conn, "SELECT COUNT(user_no) as user_count FROM `storage` WHERE `user_no` = '$_SESSION[user]'") or die(mysqli_error());
    $fetch = mysqli_fetch_array($query);
?>
...
<?php 
    $query2 = mysqli_query($conn, "SELECT COUNT(user_no) as user_count FROM `storage_outgoing` WHERE `user_no` = '$_SESSION[user]'") or die(mysqli_error());
...
<?php 
    $query4 = mysqli_query($conn, "SELECT COUNT(user_id) as user_count FROM `outgoing_downloads` WHERE `user_id` = '$_SESSION[user]'") or die(mysqli_error());
    $fetch4 = mysqli_fetch_array($query4);
?>
                                                Total Mail Downloads </div>
