<?php
	...
	if(ISSET($_POST['save'])){
		...
		if(move_uploaded_file($file_temp, $location)){
			...
			mysqli_query($conn, "INSERT INTO storage (filename, file_type, date_uploaded, date_received, lastactioned, user_no, address, subjectMatter, policy, acknowledge) 
							VALUES('$newFilename', '$file_type', '$incomingDate', '$receivedDate', '$lastactioned', '$user_no', '$address', '$subjectMatter', '$policy', 'Not Acknowledged')") or die(mysqli_error());
