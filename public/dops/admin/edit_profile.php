                            ...
                            <div class="card-body">
                                <form method="POST" action="edit_profile.php">	
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="firstname" class="form-control" required="required" readonly value="<?php echo $fetch_user['firstname'];?>" />
                                            </div>
                                            <div class="form-group">
                                                <label>Lastname</label>
                                                <input type="text" name="lastname" class="form-control" required="required" readonly value="<?php echo $fetch_user['lastname'];?>"  />
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <?php 
                                                    ...
                                                    if(ISSET($_POST['save'])){
                                                        ...
                                                        if($fetch_user['password'] != $old_password ){
                                    ...
                                    <div>
                                        <button name="save" class="btn btn-success" ><span class="glyphicon glyphicon-save"></span> Edit Profile</button>
                                    </div>
                                </form>
                            </div>
                        </div>
