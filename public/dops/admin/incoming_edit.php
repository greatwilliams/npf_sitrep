            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                        <div class="card-body">
                            <form class="forms-sample" enctype="multipart/form-data" method="POST" action="../save_file_editIncoming2.php" >
                            ...
                            <button type="submit"  name="update_incoming" class="d-none d-sm-inline-block btn btn-sm btn-dark shadow-sm">Submit</button>
