...
class AdminController extends Controller
{
    ...
    public function RegisterAnalyst(){
        $states = State::all();
        //dd($states);
        return view('sitrep.admin.register_analyst',compact('states'));
    } // End Mehtod 
     ...
     public function StoreAnalyst(Request $request)
    {
     ...
     public function Inactiveanalyst(){
        $inActiveAnalyst = User::where('status','inactive')->where('state','!=', 'FHQ')->latest()->get();
    ...
    public function Activeanalyst(){
        $inActiveAnalyst = User::where('status','active')
        ->where('state', '!=' ,'FHQ')
        ->latest()->get();
