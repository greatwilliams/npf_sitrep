...
<div class="page-content"> 
    <!--breadcrumb-->
	{{-- Alert Message --}}
    {{-- FIX: Check for the $message variable directly, as it's passed from the controller --}}
    @if(isset($message))
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Add Sitrep testing</div>
        <div class="ps-3">
								   ...
								   @endphp
									 ...
									 <tr>                    
									   ...
									   <td colspan="3"> <b>  {{ $sitrep['crime_type_details']['crime_type']}} </b></td>
										 <td align="center">{{$sitrep->state_id}}</td>
										 ...
										 <td align="center">{{$sitrep->operative_casualties}}</td>
											 ...
											 <td><a class="btn btn-success" href="{{route('state.edit.sitrep', $sitrep->id)}}">Edit  </a></td>
											 </tr>
											 @endforeach
