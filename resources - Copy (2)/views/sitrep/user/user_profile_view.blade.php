								...
								<div class="card">
									<div class="card-body">
										<div class="d-flex flex-column align-items-center text-center">
                                            <img src="{{ (!empty($userData->photo)) ? url('sitrep/upload/user_images/'.$userData->photo):url('sitrep/upload/no_image.jpg') }}" alt="user" class="rounded-circle p-1 bg-primary" width="110">
                                                <div class="mt-3">
                                                    <h4>{{ $userData->name }}</h4>
