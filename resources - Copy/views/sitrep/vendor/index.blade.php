...
<body>
	...
	<div class="wrapper">
		...
		<div class="col">
			...
			<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Filter Record</button>
			<!-- Modal -->
			<div class="modal fade" id="exampleModal" tabindex="-1" aria-hidden="true">
				<div class="modal-dialog modal-sm">
					<div class="modal-content">
						...
						<form action="{{ route('vendor.dashboard2')}}" method="POST">
						@csrf
				...
				<div class="row">
					<div class="col-12 col-lg-12 col-xl-12 d-flex">
					   <div class="card w-100">
						...
						<div class="row row-cols-1 row-cols-md-2 row-cols-xl-4 g-0 row-group  border-top">
						  <div class="col">
						  ...
						  <div class="col">
							<div class="table-responsive">
								...
								<tbody>
									<tr>
									<td><i class="bx bxs-circle me-2" style="color:rgba(14, 90, 7, 0.98)"><B> VICTIMS RESCUED & KIDNAPPED</span></B></i></td>
									<td></td>
									</tr>
