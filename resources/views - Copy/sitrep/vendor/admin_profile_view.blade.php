                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{ (!empty($adminData->photo)) ? url('sitrep/upload/admin_images/'.$adminData->photo):url('sitrep/upload/no_image.jpg') }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                        <div class="mt-3">
                            ...
                            <form method="post" action="{{ route('admin.profile.store') }}" enctype="multipart/form-data" >
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" class="form-control" name="rank" value="{{ $adminData->rank }}"  />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="full_name" class="form-control" value="{{ $adminData->full_name}}" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">AP Number</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="ap_number" class="form-control" value="{{ $adminData->ap_number }}" />
                                    </div>
                                </div>
