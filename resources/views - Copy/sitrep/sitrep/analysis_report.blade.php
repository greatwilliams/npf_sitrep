...
<div class="page-content">
                        ...
                        <div>
                            <table id="example1" class="table table-striped table-bordered">
                                ...
                                @php
                                    $i=0;
                                @endphp
                                    @foreach($sitreps_state as $sitrep) 
                                    <tr>                    
                                        <td>{{$i=$i+1}}</td> 
		...
		@php
			...
			foreach ($sitreps_state2 as $sitrep) {
				$state_id2[] = $sitrep->state_id;
				$number_incident2[] = $sitrep->number_incident; 
			}
		@endphp
	</div>
	<!--end wrapper-->
			...
			var ctx = document.getElementById('chart1').getContext('2d');
				...
				var myChart = new Chart(ctx, {
					...
					data: {
						...
						{
							label: {!! json_encode($info2) !!},
							// data: [7, 5, 14, 7, 12, 6, 10, 6, 11, 5],
							data                :  {!! json_encode($number_incident2) !!},

							backgroundColor: "rgba(194, 12, 12, 0.35)",
							borderColor: "transparent",
							pointRadius :"0",
							borderWidth: 1
						}
