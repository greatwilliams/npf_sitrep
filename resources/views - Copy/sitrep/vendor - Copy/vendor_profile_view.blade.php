					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Personel Profile</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
								...
								<div class="card">
									<div class="card-body">
										<div class="d-flex flex-column align-items-center text-center">
                                            <img src="{{ (!empty($vendorData->photo)) ? url('sitrep/upload/vendor_images/'.$vendorData->photo):url('sitrep/upload/no_image.jpg') }}" alt="vendor" class="rounded-circle p-1 bg-primary" width="110">
                                                <div class="mt-3">
