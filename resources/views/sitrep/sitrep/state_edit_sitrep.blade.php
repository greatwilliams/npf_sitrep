            ...
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5">
                    <div class="card-title d-flex align-items-center">
                        ...
                        <h5 class="mb-0 text-primary">Sitrep State Registration</h5>
                    </div>
                    <hr>
                    <form class="row g-3" method="POST" action="{{route('state.update.sitrep')}}">
                        @csrf
                        <div class="col-md-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="state"  name="state2" class="form-select mb-3" aria-label="Default select example" readonly>
                                    <option value="{{ $states }}">{{ $states }}</option>
                                    <input type="hidden" value="{{ $state_id }}" name="state" >
                            </select>                                
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <select  name="city"  class="form-select mb-3" aria-label="Default select example">
                                <option value="{{$sitreps->lga}}" selected> {{$sitreps->lga}}</option>
                                @foreach ($lgas as $lga)
